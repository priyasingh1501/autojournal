...
export const MINDS: Mind[] = [
  ...
  },
  {
    ...
    era: 'Money, Habits & Wealth Psychology',
    philosophy: 'Clarity on spending, saving, and the mindset behind financial decisions',
    accent: 'rgba(74, 222, 128, 0.90)',
    symbol: '📊',
  },
  {
    id: 'health_expert',
    name: 'Health Expert',
    era: 'Evidence-Based Wellbeing',
    philosophy: 'Sleep, movement, nutrition — the foundations of sustained energy',
